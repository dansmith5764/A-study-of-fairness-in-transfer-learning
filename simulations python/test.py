...
#         var_y1 = cov1[1][1]
#         # correlation 
#         corr1 = cov1[0][1]/(var_x1*var_y1)

#         var_x2 = cov2[0][0]
#         var_y2 = cov2[1][1]
#         # correlation
#         corr2 = cov2[0][1]/(var_x2*var_y2)
...
#         ax.scatter(y[:,0], y[:,1], Gaussain_pdf(y[:,0], y[:,1], var_x2, var_y2, corr2, m2 ), c='r', marker='o')
#         ax.set_xlabel('x1')
#         ax.set_ylabel('x2')
#         ax.set_zlabel('pdf')
...
#         ax.scatter(c, cluster1[1,:],  Gaussain_pdf(cluster1[0,:] ,cluster1[1,:], var_k_1[0], var_k_1[1], corr_k_1, lis1[0] ),  c='r', marker='o')
#         ax.scatter(cluster2[0,:], cluster2[1,:],  Gaussain_pdf(cluster2[0,:], cluster2[1,:], var_k_2[0], var_k_2[1], corr_k_1_2, mean_K_2 ),  c='b', marker='o')
#         ax.set_xlabel('x1')
#         ax.set_ylabel('x2')
#         ax.set_zlabel('pdf')
...
#         # ax.scatter(cluster1[0,:], cluster1[1,:],  Gaussain_pdf(cluster1[0,:] ,cluster1[1,:], var_k_1[0], var_k_1[1], corr_k_1, mean_K_1 ),  c='r', marker='o')
#         # ax.scatter(cluster2[0,:], cluster2[1,:],  Gaussain_pdf(cluster2[0,:], cluster2[1,:], var_k_2[0], var_k_2[1], corr_k_1_2, mean_K_2 ),  c='b', marker='o')
#         # ax.set_xlabel('x1')
#         # ax.set_ylabel('x2')
#         # ax.set_zlabel('pdf')
...
#         # #plot the original data
#         # ax.scatter(x[:,0], y[:,1], Gaussain_pdf(x[:,0], y[:,1], var_x1, var_y1, corr1, m1 ), c='r', marker='o')
